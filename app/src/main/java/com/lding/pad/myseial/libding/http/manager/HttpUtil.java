...
import com.lding.pad.myseial.libding.http.ssh.SSHUtil;
import com.lding.pad.myseial.libding.http.ssh.SSLParams;
import com.lding.pad.myseial.libding.utils.BaseFileUtil;
import com.lding.pad.myseial.libding.utils.BasePackageUtil;
...
public class HttpUtil {
    ...
    private void initRetrofit() {
        ...
        httpApi = builder.baseUrl(ApiService.APP_HOST)
                .build()
